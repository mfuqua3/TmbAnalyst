...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItemCharacter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("VoteItemCharacters");
                });

            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItemUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("VoteItemUsers");
                });

            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItemUserCharacter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("VoteItemUserId");

                    b.ToTable("VoteItemUserCharacters");
                });

            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItemUserComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("VoteItemUserComments");
                });
            ...
            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItem", b =>
                {
                    ...
                    b.HasOne("TmbAnalyst.Services.DataAccess.Entities.Vote", null)
                        .WithMany("VoteItems")
            ...
            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItemCharacter", b =>
                {
                    ...
                    b.HasOne("TmbAnalyst.Services.DataAccess.Entities.VoteItem", "VoteItem")
            ...
            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.VoteItemUserCharacter", b =>
                {
                    b.HasOne("TmbAnalyst.Services.DataAccess.Entities.Character", "Character")
                        .WithMany("VoteItemUserCharacters")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TmbAnalyst.Services.DataAccess.Entities.VoteItemUser", "VoteItemUser")
                        .WithMany("VoteItemUserCharacters")
                        .HasForeignKey("VoteItemUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Character");

                    b.Navigation("VoteItemUser");
                });
            ...
            modelBuilder.Entity("TmbAnalyst.Services.DataAccess.Entities.Character", b =>
                {
                    ...
                    b.Navigation("VoteItemUserCharacters");
                });
